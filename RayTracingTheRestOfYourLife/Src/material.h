...
// refactor for varnished wood
struct scatter_record {
	ray specular_ray; // 反射光
	bool is_specular = false; // 是否反射
	color attenuation; // albedo值，albedo * S(d) * color_ray / pdf 表示最终颜色很合理
	shared_ptr<pdf> pdf_ptr; // 材质的采样概率
};
